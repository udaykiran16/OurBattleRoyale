...
namespace Invector
{
    class vHelperEditor : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            GUILayout.Label("Basic Locomotion Version: 2.4.1", EditorStyles.boldLabel);
            GUILayout.FlexibleSpace();
            ...
            GUILayout.BeginHorizontal("box");
            GUILayout.FlexibleSpace();
            GUILayout.Label("Melee Combat Version: 2.4.1", EditorStyles.boldLabel);
            GUILayout.FlexibleSpace();
            ...
            GUILayout.BeginHorizontal("box");
            GUILayout.FlexibleSpace();
            GUILayout.Label("Shooter Version: 1.3.1", EditorStyles.boldLabel);
            GUILayout.FlexibleSpace();
            if (GUILayout.Button("Check for Update"))
            {
