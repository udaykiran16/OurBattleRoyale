...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private void StartSound()
        {
            ...
            if ((objPlayer.GetComponent<V_car_user>().driving) && (objPlayer.GetComponent<V_car_user>().currCar == this.gameObject) && objPlayer.GetComponent<V_car_user>().inGarage == false)
            {
        ...
        private void Start()
        {
            if (GetComponent<V_CarControl>() != null)
            {
        ...
        private void Update()
        {
            ...
            if (m_StartedSound && GetComponent<V_CarControl>().isInGarage && objPlayer.GetComponent<V_car_user>().driving)
            {
                StopSound();
            }

            // stop sound if the player isnt driving
            if (m_StartedSound && !objPlayer.GetComponent<V_car_user>().driving)
            {
                StopSound();
            }
