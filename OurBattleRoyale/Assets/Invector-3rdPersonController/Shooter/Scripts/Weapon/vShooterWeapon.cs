...
namespace Invector.vShooter
{
    ...
    public class vShooterWeapon : vShooterWeaponBase
    {
        ...
        public UnityEvent  onReload, onFinishReload,  onEnableAim, onDisableAim, onEnableScope, onDisableScope, onFullPower;
