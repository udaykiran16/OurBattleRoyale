...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            m_WheelColliders[0].attachedRigidbody.centerOfMass = m_CenterOfMass.localPosition;
        ...
        {//fixme
            ...
            if (Input.GetButton(GetComponent<V_CarControl>().s_handbrake))
            {
                m_WheelColliders[0].brakeTorque = 600000;// hbTorque;
                m_WheelColliders[1].brakeTorque = 600000;// hbTorque;
                m_WheelColliders[2].brakeTorque = 6000000;// hbTorque;
                m_WheelColliders[3].brakeTorque = 6000000;// hbTorque;
